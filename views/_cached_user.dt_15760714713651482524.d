...
_diet_output.put("</a></li></ul><div class=\"follow\"><a class=\"button\" href=\"#\">Follow</a></div></section><section class=\"map\"><div></div></section></section><section class=\"authored-tivs-section has-box-shadow\"><h3>Tivs Authored</h3><form class=\"form user-tivs-search-form\"><div><input type=\"search\" name=\"search_user_tiv\" placeholder=\"Search authored tiv ...\"/><button type=\"button\" name=\"button\">Search</button></div></form><div class=\"search-status\"><p>Search results for <em>ice cream</em></p></div></section><section class=\"tivs-section\">");
#line 46 "user.dt"
 if (tivs.length) {
#line 47 "user.dt"
 foreach(tiv; tivs) {
