...
_diet_output.put("<!-- Pagination-->");
#line 80 "user.dt"
 if (pagination.totalPages() > 1) {
_diet_output.put("<section class=\"pagination\"><!-- Previous page-->");
#line 84 "user.dt"
 if(pagination.hasPreviousPage())  {
_diet_output.put("<div class=\"previous\"><a href=\"#\">&laquo; ");
#line 85 "user.dt"
_diet_output.htmlEscape(pagination.previousPage());
...
_diet_output.put("<div class=\"next\"><a href=\"#\">");
#line 96 "user.dt"
_diet_output.htmlEscape(pagination.nextPage());
_diet_output.put("</a></div>");
#line 95 "user.dt"
}
